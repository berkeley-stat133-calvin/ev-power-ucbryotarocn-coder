...
Chosen Question: Do states with higher renewable energy share also show
stronger EV adoption in 2023?
...
\section{Load CSVs}\label{load-csvs}

renew \textless- read\_csv(``data/renew\_use\_2023.csv'')
\textbar\textgreater{} clean\_names() total \textless-
read\_csv(``data/total\_energy\_use\_2023.csv'') \textbar\textgreater{}
clean\_names() ev \textless-
read\_csv(``data/ev-registrations-by\_state\_2023.csv'')
\textbar\textgreater{} clean\_names()
